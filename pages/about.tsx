  ...
  return (
    <>
      ...
      <section className="grid grid-cols-8 gap-16">
        <div className="items-start justify-start lg:col-span-4 order-2 md:order-none col-span-8">
        ...
        <div className="col-span-8 relative rounded-2xl p-8 border-2 border-primary bg-background h-fit lg:col-span-4">
        ...
        <div className="flex justify-between col-span-8  items-center">
